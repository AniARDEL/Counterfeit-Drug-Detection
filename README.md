...
- **Two Sequential Models**: First Model 1 (CNN-based), then Model 2 (EfficientNetB0-based) as an alternative approach
...
Comparing our sequential models shows significant performance differences:
...
1. **Different Model Architecture**:
   ...
   - **Two-phase training**: Initial training with frozen base layers followed by fine-tuning
...
4. **Enhanced Visualization**:
   - Feature importance heatmaps highlighting suspicious regions
